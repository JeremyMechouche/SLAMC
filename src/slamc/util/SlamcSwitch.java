 ...
 * @generated
 */
public class SlamcSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SlamcPackage.SLA: {
				Sla sla = (Sla)theEObject;
				T result = caseSla(sla);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SlamcPackage.SERVICE_COVERED: {
				ServiceCovered serviceCovered = (ServiceCovered)theEObject;
				T result = caseServiceCovered(serviceCovered);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SlamcPackage.SERVICE: {
				Service service = (Service)theEObject;
				T result = caseService(service);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SlamcPackage.SLO: {
				Slo slo = (Slo)theEObject;
				T result = caseSlo(slo);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SlamcPackage.STATE: {
				State state = (State)theEObject;
				T result = caseState(state);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SlamcPackage.TRANSITION: {
				Transition transition = (Transition)theEObject;
				T result = caseTransition(transition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SlamcPackage.EVENT: {
				Event event = (Event)theEObject;
				T result = caseEvent(event);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SlamcPackage.RECONFIGURATION_ACTION: {
			...
			case SlamcPackage.CLOUD_RESOURCE: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Service Covered</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Service Covered</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseServiceCovered(ServiceCovered object) {
		return null;
	}
